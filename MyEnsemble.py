# -*- coding: utf-8 -*-
"""Copy of ensemble2-IMDB.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1HzqMytidOc6K-HiD4kfV0RhFXJpV0tuv
"""
...
#train_data, valid_data, test_data = torchtext.datasets.SST.splits(TEXT, LABEL,filter_pred=lambda ex: ex.label != 'neutral')
train_data, test_data = datasets.IMDB.splits(TEXT, LABEL)
#-------------------------------------------
train_data, valid_data = train_data.split(0.02)
...
#ax[0].plot(tr_loss1, label='Training loss for CNN')
#ax[0].plot(tr_loss2, label='Training loss for LSTM')
#ax[0].plot(tr_loss3, label='Training loss for CNN-RNN')
...
#ax[1].plot(tr_acc1, label='Training accuracy for CNN')
#ax[1].plot(tr_acc2, label='Training accuracy for LSTM')
#ax[1].plot(tr_acc3, label='Training accuracy for CNN-RNN')
